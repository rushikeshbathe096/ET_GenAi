  ...
  return (
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <header className="flex flex-col gap-3 pb-8 border-b border-indigo-500/10">
        <h1 className="text-4xl font-black text-white italic tracking-tighter italic leading-none">Global Pulse Node</h1>
            ...
            {marketData.map((sector) => (
              <div key={sector.sector} className="group flex flex-col gap-2">
                ...
                <div className="h-2.5 w-full bg-white/5 rounded-full overflow-hidden border border-white/5">
                  <div 
                    className={`h-full transition-all duration-1000 ease-out group-hover:shadow-[0_0_15px_-2px_rgba(99,102,241,0.5)] ${sector.change >= 0 ? 'bg-gradient-to-r from-emerald-600 to-emerald-400 shadow-[0_0_10px_rgba(16,185,129,0.3)]' : 'bg-gradient-to-r from-rose-600 to-rose-400 shadow-[0_0_10px_rgba(244,63,94,0.3)]'}`}
                    style={{ width: `${Math.min(100, Math.abs(sector.change) * 20 + 20)}%` }}
                  />
                </div>
              </div>
            ))}
        ...
        <div className="space-y-6">
          <div className="bg-[#0c1532]/50 border border-indigo-500/10 rounded-3xl p-8 backdrop-blur-xl">
            ...
            <div className="flex flex-col items-center justify-center py-6">
              <span className="text-7xl font-black text-white italic tracking-tighter italic">Low</span>
              <p className="text-slate-500 font-bold uppercase tracking-[0.3em] text-[10px] mt-4">Risk Sentiment: Stable</p>
            </div>
          </div>
          ...
          <div className="bg-[#0c1532]/50 border border-indigo-500/10 rounded-3xl p-8 backdrop-blur-xl">
            ...
            <div className="flex flex-col items-center justify-center py-6">
              <span className="text-7xl font-black text-white italic tracking-tighter italic">Strong</span>
              <p className="text-slate-500 font-bold uppercase tracking-[0.3em] text-[10px] mt-4">Volume: 1.2x 20-Day Avg</p>
            </div>
          </div>
        </div>
      </div>
